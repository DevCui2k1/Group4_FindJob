    ...
    public class JobInformationService : IJobInformationService
    {
        ...
        public async Task<PagedResult<JobInformationViewModel>> GetAllPaging(GetJobInformationPagingRequest request)
        {
            ...
            if (!string.IsNullOrEmpty(request.keyword))
            {
                ...
                (x.JobTitle.Contains(request.keyword)) || (x.JobType.Contains(request.keyword)) || (x.Description.Contains(request.keyword)) || (x.WorkingLocation.Contains(request.keyword)) || (x.CompanyName.Contains(request.keyword)));
            }
